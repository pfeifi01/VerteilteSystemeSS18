...
region='us-west-2'
keyName='distributedSystems2018PfeifhoferM'
amiID='ami-37501207'
secGroupID='launch-wizard-1'
#############################################################################
...
scp -i $keyName.pem -o StrictHostKeyChecking=no createFiles.sh ec2-user@$dnsName:~
scp -i $keyName.pem -o StrictHostKeyChecking=no copyFromVM1ToS3.sh ec2-user@$dnsName:~